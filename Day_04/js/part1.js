function part1Main(input) {
    ...
    for (let i = 0; i <= diagY; i++) {
        for (let j = 0; j <= diagX; j++) {
...
function checkAdjacent (diagram, line, col) {
    ...
    diagram[line-1] !== undefined && diagram[line-1][col-1] !== undefined && diagram[line-1][col-1] === "@" ? adjCount++ : null;
    diagram[line-1] !== undefined && diagram[line-1][col] !== undefined && diagram[line-1][col] === "@" ? adjCount++ : null;
    diagram[line-1] !== undefined && diagram[line-1][col+1] !== undefined && diagram[line-1][col+1] === "@" ? adjCount++ : null;
    diagram[line] !== undefined && diagram[line][col-1] !== undefined && diagram[line][col-1] === "@" ? adjCount++ : null;
    diagram[line] !== undefined && diagram[line][col+1] !== undefined && diagram[line][col+1] === "@" ? adjCount++ : null;
    diagram[line+1] !== undefined && diagram[line+1][col-1] !== undefined && diagram[line+1][col-1] === "@" ? adjCount++ : null;
    diagram[line+1] !== undefined && diagram[line+1][col] !== undefined && diagram[line+1][col] === "@" ? adjCount++ : null;
    diagram[line+1] !== undefined && diagram[line+1][col+1] !== undefined && diagram[line+1][col+1] === "@" ? adjCount++ : null;
